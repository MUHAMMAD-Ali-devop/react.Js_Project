        ...
        <>
            <div className="py-16 mt-20">
                <div className='flex flex-col items-center'>
                    <p className='py-1 px-4 border-2 text-sm font-bold text-blue-700 rounded-full bg-gray-200'>Contact Us</p>
                    <p className='text-3xl font-bold my-4 text-blue-700'>Contact Us</p>
